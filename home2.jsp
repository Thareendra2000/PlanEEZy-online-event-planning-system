                            ...
                            <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                                <div class="carousel-inner" id="banner">
                                    <div class="carousel-item active" id="banner1">
                                        <img src="IMAGES/homebg6.jpg" class="carousel-image img-fluid" alt="...">
                                        
                                        <div class="carousel-caption d-flex flex-column justify-content-end">
                                            <p>Do you want to organize an event<br>without any time wasting</p>
                                            <div class="col-lg-12 ">
                                                <a class="custom-btn custom-border-btn btn" href="Events_CustomerPOV.jsp">Organize an event</a>
                                        </div>
                                        </div>
                                    </div>
                            	</div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 p-0">
                            <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                                <div class="carousel-inner" id="banner">
                                    <div class="carousel-item active" id="banner1">
                                        <img src="IMAGES/homebg.jpg" class="carousel-image img-fluid" alt="...">
                                        
                                        <div class="carousel-caption d-flex flex-column justify-content-end">
                                            <p>Do you want to market your service<br>specially on event planning</p>
                                            <div class="col-lg-12 ">
                                                <a class="custom-btn custom-border-btn btn" href="Packages_organizerPOV.jsp">add a service</a>
                                        </div>
                                    </div>
                                        </div>
                                    </div>
